...
public class TeamDAO {
	...
	public void updateTeam(int tid, String tname) throws Exception
	{
		Connection c= MyConnection.getConnection();
		PreparedStatement ps= c.prepareStatement("UPDATE Player SET Player_Name='"+tname+"'WHERE Player_ID="+tid);
		ps.executeUpdate();
